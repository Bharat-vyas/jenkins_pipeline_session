      ...
      remote.allowAnyHosts = true
		 ...
		 stage('Run Katalon test')
		   ...
		   //  sshCommand remote: remote, command: "cd /Applications/Kat*/Contents/Eclipse/Automation/NetCarrier_Portal_TestSuite/; ls"
		    sshCommand remote: remote, command: "/Applications/Kat*/Contents/MacOS./katalon --args -noSplash  -runMode=console -projectPath="/Applications/Kat*/Contents/Resources/Automation/NetCarrier_Portal_TestSuite/NetCarrier_Portal.prj" -retry=0 -testSuiteCollectionPath="Test_Suites/NetCarrier_Collection""
	    ...
	    }		//cd /Applications/Kat*/Contents/MacOS;
	}
